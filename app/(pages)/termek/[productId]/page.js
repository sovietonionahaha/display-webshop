...
const page = async ({ params }) => {
    ...
    return (
        <div className="mx-auto mt-16 w-full max-w-4/6 flex flex-col">
            <div className="mb-8 flex gap-2 text-[15px]">
            ...
            <div className="w-full flex gap-16">
                ...
                <div className="w-2/4 flex flex-col">
                    <div className="flex w-full">
                        ...
                        <a href="tel:+36704224626" className="flex items-center h-fit gap-2 py-2 px-3 cursor-pointer rounded-full border border-black/40">
            ...
            <div className="mt-[200px] flex w-full items-center">
